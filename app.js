...
// The saved theme is applied in each page's <head> (before paint) to avoid a flash.
// This wires up the floating toggle button and persists the user's choice.
(function initThemeToggle() {
    const root = document.documentElement;
    const btn = document.getElementById('theme-toggle');
    const KEY = 'roux-theme';
